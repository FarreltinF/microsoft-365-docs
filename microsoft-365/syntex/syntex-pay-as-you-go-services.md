...
|Autofill columns |The number of pages processed. Each processed page counts as one transaction. Cost is the same for one or more prompts per page. |$0.005/transaction |
